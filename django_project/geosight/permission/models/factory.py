"""Permission model that will handle permission resource.

All the queries will use through this permission.
"""
...
class PERMISSIONS:
    ...
    def get_level(self, name: str):
        ...
        try:
            return getattr(self, name.upper()).level
...
def permission_model_factory(
    ...
    class Permission(models.Model):
        ...
        def update(self, data):
            ...
            self.organization_permission = data['organization_permission']
