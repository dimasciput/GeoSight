...
from geosight.harvester.models import Harvester, HARVESTERS
...
class HarvesterPermissionTest(TestCase):
    ...
    def create_resource(self, user):
        ...
        return Harvester.permissions.create(
            user=user,
            harvester_class=HARVESTERS[0][0],
            reference_layer=reference_layer
        )

    def get_resources(self, user):
        """Create resource function."""
        return Harvester.permissions.list(user)
